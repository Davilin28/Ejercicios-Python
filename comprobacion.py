def clave(password1, password2):
    
    if password1 == password2:
        validar     =   False #que se vayan cumpliendo los requisitos uno a uno.
        long        =   len(password1) #Calcula la longitud de la contraseña
        ...
        y=password1.isalnum()#si es alfanumérica retona True
        correcto    =   True #verifica que hayan mayuscula, minuscula, numeros y no alfanuméricos
        
        for carac in password1: #ciclo for que recorre caracter por caracter en la contraseña
        ...
        if long <8 and validar == True:
            ...
            validar=False #cambia a False si no se cumple
